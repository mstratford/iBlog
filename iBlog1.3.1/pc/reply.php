	...
	<div id="page-bgbtm">
		<div id="content">
			...
			<div class="post">
				...
				<h2 class="title"><a href="">New Reply</a></h2>
				<p class="meta"><span class="date"></span><span class="posted"></span></p>
				<div style="clear: both;">&nbsp;</div>
				<div class="entry">
					<p>
             <center> Do not go over 500 characters please.</center>
                    <?php
    $id = $_GET["id"];
	?>
		
        <form action="replynow.php?id=<?php echo $id;?>" method="post">
         <center><textarea name="reply" cols="45" rows="15"></textarea></center>
