...
<div id="wrapper">
	...
	<div id="page-bgbtm">
		<div id="content">
	<div class="post">
	<h2 class="title">Choose Post</h2>
				<p class="meta"><span class="date">Use the tools to edit posts.</span></p></div>
<div class="post">
...
?>
				...
				<ul class="pageitem">
					<li class="menu"><a href="editpost.php?id=<?php echo $row["id"];?>"><span class="name">
  <?php echo $row["topic"];?></span><span class="comment">Edit</span><span class="arrow"></span></a>
