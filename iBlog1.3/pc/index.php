...
?>
  	...
  	<div class="post">
				...
				<p class="meta"><span class="date"><?php echo date('m/d/y',$row["date"])
                                ;?></span><span class="posted">Posted by <?php echo $row["user"];?></span></p>
				<div style="clear: both;">&nbsp;</div>
				<div class="entry">
					<p><?php echo shortentext($row["detail"]);?></p>
					<p class="links"><a href="blog.php?id=<?php echo $row["id"];?>">Read More</a></p>
				</div>
			</div>
...
?>
<h2>News: <?php echo $news["title"];?></h2>
					<p>
